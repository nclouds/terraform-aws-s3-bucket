...
```hcl
    module "s3" {
        source      = "git@github.com:nclouds/terraform-aws-s3-bucket.git?ref=v0.2.3"
        identifier  = "example"
        tags        = {
            Owner       = "sysops"
            env         = "dev"
...
```hcl
    ...
    module "file" {
        source      = "git@github.com:nclouds/terraform-aws-s3-bucket.git//modules/s3-object?ref=v0.2.3"
